      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm sm:text-base">
            Group products and manage inventory segments.
          </p>
        </div>
              ...
              <CardHeader className="relative flex flex-row items-start justify-between gap-3 space-y-0 pb-4">
                <div className="space-y-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {category.isAsset && (
                      <span className="inline-flex items-center rounded-full bg-blue-500/10 px-2 py-0.5 text-xs font-medium text-blue-600 ring-1 ring-inset ring-blue-500/20 shrink-0">
                        Asset
                      </span>
                    )}
                  </div>
                ...
                <div className="p-2 rounded-lg bg-primary/10 text-primary ring-1 ring-primary/20 shrink-0">
                  <Package className="h-5 w-5" />
                </div>
              </CardHeader>
              <CardContent className="relative">
                <div className="flex justify-between items-center gap-3 border-t pt-4 border-border/50 text-sm">
                  ...
                  <div className="space-y-0.5 text-right min-w-0">
                    ...
                    <span className="font-semibold text-base sm:text-lg font-mono truncate">
                      ₹
